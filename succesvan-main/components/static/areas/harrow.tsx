// components/static/areas/HarrowStatic.tsx
...
import { harrowFAQData } from "@/lib/schema";
...
const vanTypes = [
  {
    title: "Small Van Hire Harrow",
    description:
      "Compact panel vans for light deliveries, single-item collections and smaller flat moves around Harrow, HA1 and nearby North West London streets.",
  ...
  {
    title: "Medium Van Rental Harrow",
    description:
      "Transit-size vans for multi-room house moves, furniture pickup, retail stock runs and regular business deliveries across Harrow and North West London.",
  ...
  {
    title: "Large Van Hire Harrow",
    description:
      "High-roof, extra-long load bay for house clearances, construction materials, trade deliveries and larger family or student moves in HA1, HA2 and surrounding areas.",
  ...
  {
    title: "Luton Van Hire Harrow",
    description:
      "Box-body Luton vans for full house moves and complete flat clearances in Harrow and across North West London. The highest-capacity option for larger family loads.",
  ...
  {
    title: "Automatic Van Rental Harrow",
    description:
      "Prefer an automatic gearbox? Automatic vans may be available for Harrow customers — practical for urban driving around HA1, the A406 and North West London routes.",
...
const localBenefits = [
  {
    ...
    body: "Harrow HA1 and HA2 have a wide mix of semi-detached houses, terraces and purpose-built flats. A self-drive van gives you full control of your move — without the cost of a full removals team.",
  },
  {
    icon: <FiBook className="text-[#fe9a00] text-xl" aria-hidden="true" />,
    title: "Student & Family Moves",
    body: "With Harrow College and several universities accessible from Harrow, student van hire in HA1 is popular at the start and end of each academic year. Family moves across Harrow postcodes also benefit from flexible daily hire.",
  },
  {
    icon: <FiPackage className="text-[#fe9a00] text-xl" aria-hidden="true" />,
    title: "Furniture Pickup & Collections",
    body: "Collecting from IKEA, a marketplace seller or a local Harrow shop? Our medium and large vans give you the covered load space to handle bulky items safely — usually in a single trip.",
  },
  {
    icon: <FiTruck className="text-[#fe9a00] text-xl" aria-hidden="true" />,
    title: "Business Deliveries",
    body: "Trades, retailers and businesses across Harrow, Wembley, Kenton and North West London use our vans for regular deliveries, stock transport and equipment runs.",
  },
  {
    icon: <FiPackage className="text-[#fe9a00] text-xl" aria-hidden="true" />,
    title: "Storage Runs",
    body: "Moving items to or from a storage unit near Harrow, Stanmore or Edgware? Our large and Luton vans make storage trips efficient and cut the number of journeys needed.",
  },
  {
    icon: <FiClock className="text-[#fe9a00] text-xl" aria-hidden="true" />,
    title: "Short-Term & Weekend Rental",
    body: "Need a van for a weekend job in Harrow? Daily hire is available with no long-term commitment. Same-day van hire may be possible — subject to availability. Book early for the best van choice.",
  },
];
...
const whyChooseUs = [
  ...
  },
  {
    ...
    description:
      "Daily, weekly and monthly van hire for Harrow customers. Flexible pickup and return times built around your schedule.",
  },
  {
...
const nearbyAreaTags = [
  { name: "Harrow-on-the-Hill", isCurrent: true },
   { name: "North Harrow" },
  { name: "South Harrow" },
   { name: "Wembley" },
   { name: "Edgware" },
...
const useCaseSections = [
  {
    title: "House & Flat Moves in HA1 and HA2",
    body: "Harrow has a large and active residential property market across HA1, HA2 and surrounding postcodes. A self-drive van rental in Harrow puts you in control of your move timeline and keeps costs straightforward.",
  },
  {
    title: "Student Moves Near Harrow-on-the-Hill",
    body: "With Harrow College and several universities accessible from Harrow-on-the-Hill, student van hire in HA1 is in demand at term start and end. Daily hire is a cost-effective option.",
  },
  {
    title: "Family Moves Across Harrow",
    body: "Moving a family home across Harrow, Kenton, Pinner or Wealdstone? Our large vans and Luton vans give you the load space to move more in fewer trips — reducing overall moving day stress.",
  },
  {
    title: "Furniture Pickup & Marketplace Collections",
    body: "Collecting flat-pack furniture, a second-hand sofa or multiple marketplace items near Harrow? Our medium and large vans give you the right covered load space — in one trip.",
  },
  {
    title: "Business Deliveries Across North West London",
    body: "Businesses and traders in Harrow, Wembley, Kenton and Stanmore use our vans for regular stock runs, deliveries and equipment transport across North West London. Daily and weekly hire available.",
  },
  {
    title: "Storage Trips",
    body: "Moving items to a storage unit near Harrow, Stanmore or Edgware? Our large and Luton vans reduce the number of trips needed and make storage runs far more efficient.",
  },
];

const familyBusinessSection = {
  heading: "Van Rental in Harrow for Families, Shops & Local Businesses",
  paragraphs: [
    "Harrow is one of North West London's most diverse and well-connected boroughs — with strong transport links via the Metropolitan line, Piccadilly line and key roads including the A406 North Circular and A40. Whether you are a local family planning a home move, a sole trader needing regular deliveries or a small business transporting stock, our van hire in Harrow gives you a practical and cost-effective solution.",
    "Our self-drive vans suit a wide range of needs across Harrow and the surrounding HA postcodes — furniture collection, event equipment, storage runs, shop stock transport, marketplace purchases and office relocations across North West London.",
    "Unsure which van size is right for your Harrow job? Call +44 20 3011 1198 and our team can advise before you book.",
  ],
};
...
const bookingSteps = [
  ...
  },
  {
    ...
    description:
      "Choose your hire dates. Daily, weekly and monthly van rental in Harrow is available.",
  },
  {
    step: "3",
...
export default function HarrowVanHireStatic() {
  return (
    <div className="relative w-full bg-[#0f172b]">
      ...
      ═══════════════════════════════════════════════════════════════ */}
      <section aria-label="Van hire Harrow hero">
        ...
        <div className="relative w-full h-[420px] sm:h-[520px] lg:h-[600px]">
          ...
          />
          <Image
            src="https://svh-bucket-s3.s3.eu-west-2.amazonaws.com/images/harrow.webp"
            ...
            <div className="space-y-5">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#fe9a00]/10 border border-[#fe9a00]/30">
                ...
                <span className="text-[#fe9a00] font-bold text-xs sm:text-sm tracking-wide">
                  HARROW · HA1 / HA2 / NORTH WEST LONDON
                </span>
              </div>
              ...
              <p className="text-xl sm:text-2xl font-semibold text-[#fe9a00]">
                Local Van Rental in HA1, HA2 &amp; North West London from
                £78/Day
              </p>
              ...
              <p className="text-base sm:text-lg text-gray-200 leading-relaxed">
                ...
                <strong className="text-white">van hire in Harrow</strong> for
                customers across HA1, HA2, Harrow-on-the-Hill and the wider
              ...
              <p className="text-sm sm:text-base text-gray-300 leading-relaxed">
                ...
                for full house moves across Harrow and North West London. We
                also offer{" "}
                <Link
                  href="/automatic-van-hire-london
"
                ...
                — ideal for urban driving on Harrow's roads and the A406. Rates
              ...
              <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-start gap-3">
                ...
                <div>
                  <p className="text-white font-bold text-sm mb-0.5">
                    Harrow — A406, Metropolitan Line &amp; Piccadilly Line
                    Access
                  </p>
                  <p className="text-gray-300 text-xs leading-relaxed">
                    Serving customers near Harrow-on-the-Hill, Harrow &amp;
                    Wealdstone, Kenton, North Harrow, South Harrow, Wembley,
                    Stanmore and all HA postcodes via the A406 North Circular.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8">
              <h2 className="text-xl font-black text-white mb-2">
                Van Hire in Harrow — Perfect For:
              </h2>
              <p className="text-gray-400 text-xs mb-5 leading-relaxed">
                Our Harrow van hire service covers everyday and business needs
                across HA1, HA2 and North West London.
              </p>
              ...
              <div className="p-4 rounded-xl bg-green-500/10 border border-green-500/20 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-green-200 text-xs leading-relaxed">
                    Daily, weekly or monthly van rental in Harrow — flexible to
                    suit your schedule.
                  </p>
                </div>
              </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            >
              Local Van Hire in Harrow for Moving, Deliveries &amp; Everyday
              Jobs
            </h2>
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed">
              Whether you are moving a family home in HA1, collecting furniture
              from a local seller or running business deliveries across North
              West London, our{" "}
              <strong className="text-white">van rental in Harrow</strong> gives
          ...
          <p className="text-center text-gray-400 text-sm mt-10">
            Need a van at short notice in Harrow?{" "}
            <a
              href="tel:+442030111198"
              className="text-[#fe9a00] hover:underline font-semibold"
            >
            ...
            — same-day van hire near Harrow-on-the-Hill may be available subject
            to availability.
          </p>
        </div>
      </section>
...
"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto">
              ...
              <strong className="text-white">Harrow van hire</strong> and van
          ...
          <div className="grid lg:grid-cols-1 gap-12 items-start">
            <div>
              <h2
                ...
                className="text-3xl sm:text-4xl font-black text-white mb-4"
              >
                Van Hire Near Harrow-on-the-Hill, Kenton &amp; HA1
              </h2>
              ...
              <p className="text-gray-300 text-base leading-relaxed mb-4">
                ...
                service covers HA1, HA2 and all surrounding North West London
                areas. Whether you are based near Harrow &amp; Wealdstone, North
                Harrow, South Harrow, Kenton, Wembley, Stanmore, Edgware or
                Pinner — we can advise on the right van size and check
                availability for your dates.
              </p>

              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Harrow is well connected via the Metropolitan line, Piccadilly
                line, A406 North Circular and A40 — making it one of North West
                London&apos;s most accessible points for van rental. Customers
                searching for{" "}
                <Link
                ...
                in HA1 or HA2 will find our North West London service a
            ...
            <div className="rounded-2xl overflow-hidden border border-white/10 h-full">
              <GoogleMapLoader
                ...
                fromLng={-0.33333}
                distance="4.2 miles"
                duration="15–20 minutes via A406"
              />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2
              ...
              className="text-3xl sm:text-4xl font-black text-white mb-4"
            >
              Popular Reasons to Hire a Van in Harrow
            </h2>
            <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto">
              Why HA1, HA2 and North West London customers choose{" "}
              <strong className="text-white">van hire in Harrow</strong> with
              Success Van Hire.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2
              ...
              className="text-3xl sm:text-4xl font-black text-white mb-4"
            >
              Book Van Hire in Harrow in 4 Simple Steps
            </h2>
      ...
      ═══════════════════════════════════════════════════════════════ */}
      <FAQComponent
        title="Van Hire Harrow — Frequently Asked Questions"
        subtitle="Common questions from customers searching for van hire in Harrow, HA1, HA2 and North West London"
        faqs={harrowFAQData}
        showSearch={false}
        defaultOpen={0}
        accentColor="#fe9a00"
      ...
      <GoogleReviewsBanner
        ...
        description="Trusted by customers in Harrow, Wembley, Kenton and across North West London."
      />
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Ready to Book Van Hire in Harrow?
          </h2>
          <p className="text-gray-300 text-base sm:text-lg leading-relaxed mb-8 max-w-2xl mx-auto">
            ...
            <strong className="text-white">self-drive van hire Harrow</strong>{" "}
