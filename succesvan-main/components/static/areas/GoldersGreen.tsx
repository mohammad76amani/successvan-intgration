// components/static/areas/GoldersGreenStatic.tsx
...
import { goldersGreenFAQData } from "@/lib/schema";
...
const vanTypes = [
  {
    title: "Small Van Hire Golders Green",
    description:
      "Compact panel vans for light deliveries, single-item collections and smaller flat moves around Golders Green, NW11 and nearby streets.",
  ...
  {
    title: "Medium Van Rental Golders Green",
    description:
      "Transit-size vans for multi-room flat moves, furniture pickup, retail stock runs and regular business deliveries across Golders Green and North West London.",
  ...
  {
    title: "Large Van Hire Golders Green",
    description:
      "High-roof, extra-long load bay for house clearances, construction materials, trade deliveries and larger student moves in NW11 and surrounding areas.",
  ...
  {
    title: "Luton Van Hire Golders Green",
    description:
      "Box-body Luton vans for full house moves and complete flat clearances in Golders Green and across North West London. The highest-capacity option for larger loads.",
  ...
  {
    title: "Automatic Van Hire Golders Green",
    description:
      "Prefer an automatic gearbox? Automatic vans may be available for Golders Green customers — ideal for easier urban driving on the A406, A1 and NW London routes.",
...
const localBenefits = [
  {
    ...
    body: "Golders Green NW11 has a high density of period houses and purpose-built flats. A self-drive van in Golders Green gives you full control of your move — without the cost of a full removals team.",
  },
  {
    icon: <FiBook className="text-[#fe9a00] text-xl" aria-hidden="true" />,
    title: "Student Moves",
    body: "With the Northern line connecting Golders Green to UCL, SOAS and central London universities, student van hire in NW11 is popular at the start and end of each term.",
  },
  {
    icon: (
    ...
    body: "Collecting from IKEA, a marketplace seller or a local Golders Green shop? Our medium and large vans give you the covered space you need — in a single trip.",
  },
  {
    icon: <FiTruck className="text-[#fe9a00] text-xl" aria-hidden="true" />,
    title: "Business Deliveries",
    body: "Local businesses across Golders Green, Hampstead, Hendon and Cricklewood use our vans for regular deliveries, stock transport and equipment runs across NW London.",
  },
  {
    icon: <FiPackage className="text-[#fe9a00] text-xl" aria-hidden="true" />,
    title: "Storage Runs",
    body: "Moving items to or from a storage unit near Golders Green, Hendon or Brent Cross? Our large vans and Luton vans make storage trips far more efficient.",
  },
  {
    icon: <FiClock className="text-[#fe9a00] text-xl" aria-hidden="true" />,
    title: "Short-Term & Weekend Rental",
    body: "Need a van for a day or weekend job in Golders Green? Daily hire is available with no long-term commitment. Same-day van hire may be possible — subject to availability.",
  },
];
...
const whyChooseUs = [
  ...
  },
  {
    ...
    description:
      "Daily, weekly and monthly van hire for Golders Green customers. Flexible pickup and return times built around your schedule.",
  },
  {
...
const nearbyAreaTags = [
  { name: "Golders Green Station", isCurrent: true },
    { name: "Hampstead" },
  { name: "Hendon" },
  { name: "Brent Cross" },
  { name: "Cricklewood" },
...
const nearbyAreaLinks = [
  ...
  { name: "Finchley", href: "/van-hire-finchley" },
  { name: "NW London", href: "/van-hire-north-west-london" },
];

const useCaseSections = [
  {
    title: "House & Flat Moves in NW11",
    body: "Golders Green has a high density of rental flats and owner-occupier houses. A self-drive van rental in Golders Green gives you full control of timing and keeps moving costs predictable.",
  },
  {
    title: "Student Moves Near Golders Green Station",
    body: "With the Northern line connecting Golders Green Station to central London universities, student van hire in NW11 is popular at the start and end of term. Daily hire keeps the cost manageable.",
  },
  {
    title: "Furniture Pickup & Marketplace Collections",
    body: "Whether you are collecting flat-pack furniture, a second-hand sofa or multiple marketplace items near Golders Green, our medium and large vans give you the right covered load space — in one trip.",
  },
  {
    title: "Business Deliveries Across NW London",
    body: "Local businesses in Golders Green, Hampstead and Hendon use our vans for regular stock runs, trade deliveries and equipment transport across North West London. Daily and weekly hire available.",
  },
  {
    title: "Storage Trips",
    body: "Moving items to a storage unit near Golders Green, Brent Cross or Hendon? Our large and Luton vans reduce the number of trips needed and make storage runs far more efficient.",
  },
  {
    title: "Weekend & Short-Term Moving Jobs",
    body: "Prefer to move over a weekend? Short-term van rental in Golders Green lets you work at your own pace. Book in advance for the best choice of van sizes.",
  },
];

const communitySection = {
  heading: "Van Rental in Golders Green for Local Families, Shops & Businesses",
  paragraphs: [
    "Golders Green is one of North West London's most well-connected areas — with strong links via the Northern line, the A406 North Circular, A1 and A41. Whether you are a local family moving between properties, a small business needing regular deliveries or a shop owner transporting stock, our van hire in Golders Green gives you a practical and cost-effective solution.",
    "Our self-drive vans suit a wide range of needs — furniture collection, storage runs, event equipment, office moves, marketplace purchases and commercial deliveries across NW11 and wider North West London.",
    "Unsure which van size you need? Call our team on +44 20 3011 1198 and we can advise based on your specific load and journey before you book.",
  ],
};
...
const bookingSteps = [
  ...
  },
  {
    ...
    description:
      "Choose your hire dates. Daily, weekly and monthly van rental in Golders Green is available.",
  },
  {
    step: "3",
...
export default function GoldersGreenVanHireStatic() {
  return (
    <div className="relative w-full bg-[#0f172b]">
      ...
      ═══════════════════════════════════════════════════════════════ */}
      <section aria-label="Van hire Golders Green hero">
        ...
        <div className="relative w-full h-[420px] sm:h-[520px] lg:h-[600px]">
          ...
          />
          <Image
            src="https://svh-bucket-s3.s3.eu-west-2.amazonaws.com/images/Golders+Green+van+hire.png"
            ...
            <div className="space-y-5">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#fe9a00]/10 border border-[#fe9a00]/30">
                ...
                <span className="text-[#fe9a00] font-bold text-xs sm:text-sm tracking-wide">
                  GOLDERS GREEN · NW11 / NORTH WEST LONDON
                </span>
              </div>
              ...
              <p className="text-xl sm:text-2xl font-semibold text-[#fe9a00]">
                Local Van Rental in NW11 &amp; North West London from £78/Day
              </p>
              ...
              <p className="text-base sm:text-lg text-gray-200 leading-relaxed">
                ...
                <strong className="text-white">
                  van hire in Golders Green
                </strong>{" "}
                for customers across NW11, near Golders Green Station and the
                wider North West London area. Whether you need a van for a house
                move, furniture pickup, student relocation or business
...
"
                ...
                around Golders Green. Rates from £78/day with daily, weekly and
                monthly options.
              </p>
              ...
              <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-start gap-3">
                ...
                <div>
                  <p className="text-white font-bold text-sm mb-0.5">
                    Golders Green — A406, A1 &amp; Northern Line Access
                  </p>
                  <p className="text-gray-300 text-xs leading-relaxed">
                    Serving customers near Golders Green Station, Temple
                    Fortune, Hampstead, Hendon, Brent Cross, Cricklewood,
                    Finchley and all NW11 postcodes via the A406 and A1.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8">
              <h2 className="text-xl font-black text-white mb-2">
                Van Hire in Golders Green — Perfect For:
              </h2>
              <p className="text-gray-400 text-xs mb-5 leading-relaxed">
                Our Golders Green van hire service covers everyday and business
                needs across NW11 and North West London.
              </p>
              ...
              <div className="p-4 rounded-xl bg-green-500/10 border border-green-500/20 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-green-200 text-xs leading-relaxed">
                    Daily, weekly or monthly van rental in Golders Green —
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            >
              Local Van Hire in Golders Green for Moving, Deliveries &amp;
              Everyday Jobs
            </h2>
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed">
              Whether you are relocating a flat in NW11, collecting furniture
              from a local seller or running business deliveries across North
              West London, our{" "}
              <strong className="text-white">
                van rental in Golders Green
              </strong>{" "}
          ...
          <p className="text-center text-gray-400 text-sm mt-10">
            Need a van at short notice in Golders Green?{" "}
            <a
              href="tel:+442030111198"
              className="text-[#fe9a00] hover:underline font-semibold"
            >
            ...
            — same-day van hire near Golders Green Station may be available
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2
              ...
              className="text-3xl sm:text-4xl font-black text-white mb-4"
            >
              Choose the Right Van Rental in Golders Green
            </h2>
            <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto">
              Not sure which van size you need? Use this guide to find the right
              van for your job in Golders Green and NW11.
            </p>
          </div>
...
"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto">
              ...
              <strong className="text-white">Golders Green van hire</strong> and
          ...
          <div className="grid lg:grid-cols-1 gap-12 items-start">
            <div>
              <h2
                ...
                className="text-3xl sm:text-4xl font-black text-white mb-4"
              >
                Van Hire Near Golders Green Station, Hampstead &amp; NW11
              </h2>
              ...
              <p className="text-gray-300 text-base leading-relaxed mb-4">
                ...
                service covers NW11 and all surrounding North West London areas.
                Whether you are based near Temple Fortune, Hampstead, Hendon,
                Brent Cross, Cricklewood, Finchley or Hampstead Garden Suburb —
                we can advise on the right van and check availability for your
                dates.
              </p>

              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Golders Green sits at the junction of the A406, A1 and the
                Northern line — giving customers in NW11 straightforward access
                across North West London. Customers searching for{" "}
                <Link
                ...
                in NW11 will find our North West London service a practical and
                accessible choice.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2
              ...
              className="text-3xl sm:text-4xl font-black text-white mb-4"
            >
              Popular Reasons to Hire a Van in Golders Green
            </h2>
            <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto">
              Why NW11 and North West London customers choose{" "}
              <strong className="text-white">van hire in Golders Green</strong>{" "}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-10">
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3">
              ...
              >
                <FiTruck aria-hidden="true" />
                Book van hire Golders Green online
              </Link>
              <a
                href="tel:+442030111198"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2
              ...
              className="text-3xl sm:text-4xl font-black text-white mb-4"
            >
              Book Van Hire in Golders Green in 4 Simple Steps
            </h2>
      ...
      ═══════════════════════════════════════════════════════════════ */}
      <FAQComponent
        title="Van Hire Golders Green — Frequently Asked Questions"
        subtitle="Common questions from customers searching for van hire in Golders Green, NW11 and North West London"
        faqs={goldersGreenFAQData}
        showSearch={false}
        defaultOpen={0}
        accentColor="#fe9a00"
      ...
      <GoogleReviewsBanner
        highlight="NW London"
        description="Trusted by customers in Golders Green, Hampstead, Hendon and across North West London."
      />
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Ready to Book Van Hire in Golders Green?
          </h2>
